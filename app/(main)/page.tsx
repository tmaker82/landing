...
import {isParenthesizedTypeNode} from "tsutils";
...
const Dashboard = () => {
    ...
    return (
        <div className="grid">
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    <h5>Запросы из некста</h5>
                    <DataTable value={users} rows={5} paginator responsiveLayout="scroll">
                        <Column field="displayname" header="displayname" sortable style={{ width: '35%' }} />
                        <Column field="email" header="email" sortable style={{ width: '55%' }} />
                        <Column
                            header="View"
                            style={{ width: '15%' }}
                            body={() => (
